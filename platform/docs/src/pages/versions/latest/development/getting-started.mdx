...
<center>
<<<<<<< HEAD:platform/docs/src/pages/versions/latest/development/getting-started.mdx
  <img
    alt="development server hosted app"
    src="/assets/img/loading-study.gif"
  />
=======
...
>>>>>>> docs/v2-main-tmp:docs/v2/development/getting-started.md
